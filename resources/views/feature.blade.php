...
@section('title', 'Özellikler - UK Elektronik')

@section('content')
    <!-- Page Header Start -->
    <div class="container-fluid page-header py-5 mb-5">
        <div class="container py-5">
            <h1 class="display-3 text-white mb-3 animated slideInDown">Özellikler</h1>
            <nav aria-label="breadcrumb animated slideInDown">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item text-white active" aria-current="page">Özellikler</li>
                </ol>
            </nav>
        </div>
    </div>
        ...
        <div class="container">
            <div class="row g-5">
                <div class="col-md-6 col-lg-3 wow fadeIn" data-wow-delay="0.1s">
                    ...
                    <span>Memnuniyetle hizmet verdiğimiz müşterilerimiz</span>
                </div>
                <div class="col-md-6 col-lg-3 wow fadeIn" data-wow-delay="0.3s">
                    ...
                    <span>Başarıyla tamamladığımız projelerimiz</span>
                </div>
                <div class="col-md-6 col-lg-3 wow fadeIn" data-wow-delay="0.5s">
                    ...
                    <h5 class="mb-3">Kazanılan Ödül</h5>
                    <span>Başarılarımızla kazandığımız ödüller</span>
                </div>
                <div class="col-md-6 col-lg-3 wow fadeIn" data-wow-delay="0.7s">
                    ...
                    <h5 class="mb-3">Uzman Çalışan</h5>
                    <span>Alanında uzman profesyonel ekibimiz</span>
                </div>
            </div>
        </div>
    </div>
