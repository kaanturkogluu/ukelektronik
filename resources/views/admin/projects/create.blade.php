            ...
            <div class="mb-3">
                ...
                <div class="tab-content">
                    <div class="tab-pane fade show active" id="title_tr" role="tabpanel">
                        <input type="text" class="form-control" name="title_tr" value="{{ old('title_tr') }}" required>
                    </div>
            ...
            <div class="mb-3">
                ...
                <div class="tab-content">
                    <div class="tab-pane fade show active" id="desc_tr" role="tabpanel">
                        <textarea class="form-control" name="description_tr" rows="5" required>{{ old('description_tr') }}</textarea>
                    </div>
