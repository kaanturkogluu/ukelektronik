...
@section('page-title', 'Yeni Hizmet')
        ...
        <form action="{{ route('admin.services.store') }}" method="POST" enctype="multipart/form-data" id="serviceForm">
            ...
            <div class="mb-4">
                ...
                <div class="tab-content">
                    <div class="tab-pane fade show active" id="title_tr" role="tabpanel">
                        <input type="text" class="form-control" name="title_tr" value="{{ old('title_tr') }}" required placeholder="Örn: Güneş Paneli Kurulumu">
                    </div>
                    <div class="tab-pane fade" id="title_en" role="tabpanel">
                        <input type="text" class="form-control" name="title_en" value="{{ old('title_en') }}" required placeholder="Ex: Solar Panel Installation">
                    </div>
                </div>
            </div>
            ...
            <div class="mb-4">
                ...
                <div class="input-group">
                    <input type="text" class="form-control" id="iconInput" name="icon" value="{{ old('icon') }}" placeholder="fa-solar-panel" readonly>
                ...
                <div class="card border-primary">
                    <div class="card-body">
                        ...
                        <div id="urlInputContainer">
                            ...
                            <input type="text" class="form-control" id="imageUrl" name="image" value="{{ old('image') }}" placeholder="https://example.com/image.jpg veya /img/service.jpg">
            ...
            <div class="mb-4">
                ...
                <ul class="nav nav-tabs mb-2" role="tablist">
                    <li class="nav-item" role="presentation">
                        <button class="nav-link active" data-bs-toggle="tab" data-bs-target="#short_desc_tr" type="button" role="tab">Türkçe</button>
                    </li>
                    <li class="nav-item" role="presentation">
                        <button class="nav-link" data-bs-toggle="tab" data-bs-target="#short_desc_en" type="button" role="tab">English</button>
                    </li>
                </ul>
                <div class="tab-content">
                    <div class="tab-pane fade show active" id="short_desc_tr" role="tabpanel">
                        <textarea class="form-control" name="short_description_tr" rows="3" required placeholder="Hizmetin kısa tanımı...">{{ old('short_description_tr') }}</textarea>
                    </div>
                    <div class="tab-pane fade" id="short_desc_en" role="tabpanel">
                        <textarea class="form-control" name="short_description_en" rows="3" required placeholder="Short description of the service...">{{ old('short_description_en') }}</textarea>
                    </div>
                </div>
            </div>
                ...
                <div class="card border-success">
                    <div class="card-body">
                        <div id="benefitsContainer">
                            <!-- Avantajlar buraya dinamik olarak eklenecek -->
                        </div>
