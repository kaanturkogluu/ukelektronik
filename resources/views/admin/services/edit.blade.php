            ...
            <div class="mb-4">
                ...
                <div class="tab-content">
                    <div class="tab-pane fade show active" id="short_desc_tr" role="tabpanel">
                        <textarea class="form-control" name="short_description_tr" rows="3" required placeholder="Hizmetin kısa tanımı...">{{ old('short_description_tr', $shortDescTranslations['tr'] ?? '') }}</textarea>
                    </div>
                    <div class="tab-pane fade" id="short_desc_en" role="tabpanel">
                        <textarea class="form-control" name="short_description_en" rows="3" required placeholder="Short description of the service...">{{ old('short_description_en', $shortDescTranslations['en'] ?? '') }}</textarea>
                    </div>
                </div>
            </div>
            ...
            <div class="mb-4">
                ...
                <div class="tab-content">
                    <div class="tab-pane fade show active" id="desc_tr" role="tabpanel">
                        <textarea class="form-control" name="description_tr" rows="6" required placeholder="Hizmetin detaylı açıklaması (Türkçe)...">{{ old('description_tr', $descTranslations['tr'] ?? '') }}</textarea>
                    </div>
                    <div class="tab-pane fade" id="desc_en" role="tabpanel">
                        <textarea class="form-control" name="description_en" rows="6" required placeholder="Detailed description of the service (English)...">{{ old('description_en', $descTranslations['en'] ?? '') }}</textarea>
                    </div>
                </div>
            </div>
