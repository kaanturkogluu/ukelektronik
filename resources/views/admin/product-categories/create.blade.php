...
@section('title', 'Yeni Ürün Kategorisi')
@section('page-title', 'Yeni Ürün Kategorisi')

@section('content')
<div class="card">
    <div class="card-header">
        <h5 class="mb-0">Yeni Ürün Kategorisi Ekle</h5>
    </div>
    <div class="card-body">
        @if($errors->any())
            ...
            <div class="mb-3">
                ...
                <div class="tab-content">
                    <div class="tab-pane fade show active" id="desc_tr" role="tabpanel">
                        <textarea class="form-control" name="description_tr" rows="3">{{ old('description_tr') }}</textarea>
                    </div>
